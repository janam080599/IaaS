...
req_que_url = 'https://sqs.us-east-1.amazonaws.com/109585722114/cse-546-p1-input'
...
def get_active_app_ins():
    ...
    for instance in instances:
        if instance.id != 'i-0b0f1950b3db2f546' :
...
runuser -l ubuntu -c 'screen -dm bash -c "python3 /home/ubuntu/classifier/index.py ; exec sh"'
"""
